...
echo -e "${C}A ► SSH, Dropbear, OpenVPN, Squid${R}                        "
echo -e "${C}B ► Websocket, Servis OHP${R}                                "
echo -e "${C}C ► L2TP, Servis SSTP, Servis PPTP${R}                       "
echo -e "${C}D ► Wireguard, Servis Shadowsocks & SSR${R}                  "
echo -e "${C}E ► V2ray Vmess/Vless/Trojan (Ws)${R}                        "
echo -e "${C}F ► Xray Vmess/Vless/Trojan (Ws, Tcp, Kcp, Xtls, Grpc)${R}   "
echo -e "${C}G ► Trojan Go${R}                                            "
echo -e "${D}—————————————————————————————————————————————————————————${R}"
...
echo -e "${B}[3]${R} Pakej 3 ► [A,B,D,E,F] (Hot Pick)                     "
echo -e "${D}—————————————————————————————————————————————————————————${R}"
...
echo -e "${B}[6]${R} Pakej 6 ► Core Xray [A,B,D,F] (Hot Pick)             "
