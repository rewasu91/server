...
echo -e "     * [2] Pakej 2 - Semua Servis [A,B,C,D,E,F,G]            *"
echo -e "     * [2] Pakej 2 - Core V2ray V1 [A,B,C,D,E]               *"
echo -e "     * [3] Pakej 3 - Core Xray V1 [A,B,C,D,F]                *"
echo -e "     * [4] Pakej 4 - Core V2ray + Trojan Go [A,B,C,D,E,G]    *"
