...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/etc/xray/xrayvlesstls.json")
	if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
		...
		echo -e ""
		echo -e "${D}——————————————————————————————————————————————————————————${R}"
		echo -e "${D1}                Memadam Akaun Xray Vless                  ${R}"
		echo -e "${D}——————————————————————————————————————————————————————————${R}"
		echo -e ""
...
sed -i "/^### $user $exp/,/^},{/d" /etc/xray/xrayvlesstls.json
sed -i "/^### $user $exp/,/^},{/d" /etc/xray/xrayvlessnonetls.json
...
echo -e ""
echo -e "${D}——————————————————————————————————————————————————————————${R}"
echo -e "${D1}              Akaun XrayVless Berjaya Dipadam             ${R}"
echo -e "${D}——————————————————————————————————————————————————————————${R}"
echo -e ""
