...
cd /usr/bin
rm menu
wget -O menu "https://raw.githubusercontent.com/rewasu91/public/main/menu/menupakej7/menu1.sh"
chmod +x menu
clear
echo -e ""
echo -e "${D}——————————————————————————————————————————————————————————${R}"
...
cd /usr/bin
rm menu
wget -O menu "https://raw.githubusercontent.com/rewasu91/public/main/menu/menupakej7/menu2.sh"
chmod +x menu
clear
echo -e ""
echo -e "${D}——————————————————————————————————————————————————————————${R}"
...
cd /usr/bin
rm menu
wget -O menu "https://raw.githubusercontent.com/rewasu91/public/main/menu/menupakej7/menu3.sh"
chmod +x menu
clear
echo -e ""
echo -e "${D}——————————————————————————————————————————————————————————${R}"
