...
echo -e "${D}————————————————————————————————————————————————————————————————${R}"
echo -e ""
echo -e "      ${B}[01]${R} ► Menu SSH & OVPN     ${B}[05]${R} ► Menu V2RAY CORE       "
echo -e "      ${B}[02]${R} ► Menu SSR            ${B}[06]${R} ► Menu XRAY CORE        "
echo -e "      ${B}[03]${R} ► SHADOWSOCKS         ${B}[07]${R} ► Menu TROJAN           "
echo -e "      ${B}[04]${R} ► WIREGUARD           ${B}[08]${R} ► Tukar STYLE MENU      "
echo -e ""
echo -e "${D}————————————————————————————————————————————————————————————————${R}"
echo -e ""
...
echo -e "${B}[22]${R} ► Menu UPDATE"
echo -e "${B}[23]${R} ► Kembali ke Menu Utama"
echo -e "${B}[24]${R} ► Keluar"
echo -e ""
echo -e "${D}——————————————————————————————————————————————————————————${R}"

read -p "► Sila masukkan nombor pilihan anda [1-24]: " menu
echo -e ""
case $menu in
1)
menu-sshvpn
