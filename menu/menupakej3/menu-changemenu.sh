...
echo -e "${D}——————————————————————————————————————————————————————————${R}"
echo -e ""
echo -e "${B}[01]${R} ► Menu Style 1 (10 Sub Menu)"
echo -e "${B}[02]${R} ► Menu Style 2 (24 Sub Menu)"
echo -e "${B}[03]${R} ► Menu Style 3 (93 Sub Menu)"
...
cd /usr/bin
rm menu
wget -O menu "https://raw.githubusercontent.com/rewasu91/public/main/menu/menupakej3/menu1.sh"
chmod +x menu
clear
echo -e ""
echo -e "${D}——————————————————————————————————————————————————————————${R}"
...
cd /usr/bin
rm menu
wget -O menu "https://raw.githubusercontent.com/rewasu91/public/main/menu/menupakej3/menu2.sh"
chmod +x menu
clear
echo -e ""
echo -e "${D}——————————————————————————————————————————————————————————${R}"
...
cd /usr/bin
rm menu
wget -O menu "https://raw.githubusercontent.com/rewasu91/public/main/menu/menupakej3/menu3.sh"
chmod +x menu
clear
echo -e ""
echo -e "${D}——————————————————————————————————————————————————————————${R}"
