...
echo -e ""
echo -e "     —————————————————————————————————————————————————————————"
echo -e "     *        Autoskrip VPS Premium KaizenVPN Pakej 4        *"
echo -e "     —————————————————————————————————————————————————————————"
...
sleep 2
clear
wget https://raw.githubusercontent.com/rewasu91/vps/main/install/ssh-vpn4.sh && chmod +x ssh-vpn4.sh && ./ssh-vpn4.sh
clear
echo -e ""
echo -e "${D}—————————————————————————————————————————————————————${R}"
