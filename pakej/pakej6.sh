...
echo -e ""
echo -e "     —————————————————————————————————————————————————————————"
echo -e "     *        Autoskrip VPS Premium KaizenVPN Pakej 6        *"
echo -e "     —————————————————————————————————————————————————————————"
...
sleep 2
clear
wget https://raw.githubusercontent.com/rewasu91/vps/main/install/ssh-vpn6.sh && chmod +x ssh-vpn6.sh && ./ssh-vpn6.sh
clear
echo -e ""
echo -e "${D}—————————————————————————————————————————————————————${R}"
