...
echo -e "${D}—————————————————————————————————————————————${R}"
sleep 2
wget https://raw.githubusercontent.com/rewasu91/server/main/install/ins-vt.sh && chmod +x ins-vt.sh && ./ins-vt.sh
clear
echo -e ""
echo -e "${D}—————————————————————————————————————————————${R}"
...
echo -e "${D}—————————————————————————————————————————————${R}"
sleep 2
wget https://raw.githubusercontent.com/rewasu91/server/main/install/ins-trgo.sh && chmod +x ins-trgo.sh && ./ins-trgo.sh
clear
echo -e ""
echo -e "${D}—————————————————————————————————————————————${R}"
