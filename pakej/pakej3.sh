...
echo -e ""
echo -e "     —————————————————————————————————————————————————————————"
echo -e "     *        Autoskrip VPS Premium KaizenVPN Pakej 3        *"
echo -e "     —————————————————————————————————————————————————————————"
...
sleep 2
clear
wget https://raw.githubusercontent.com/rewasu91/vps/main/install/ssh-vpn3.sh && chmod +x ssh-vpn3.sh && ./ssh-vpn3.sh
clear
echo -e ""
echo -e "${D}—————————————————————————————————————————————————————${R}"
...
echo -e ""
echo -e "${D}—————————————————————————————————————————————${R}"
echo -e "${D1}             Memasang Servis V2ray           ${R}"
echo -e "${D}—————————————————————————————————————————————${R}"
sleep 2
wget https://raw.githubusercontent.com/rewasu91/vps/main/install/ins-vt.sh && chmod +x ins-vt.sh && ./ins-vt.sh
clear
echo -e ""
echo -e "${D}—————————————————————————————————————————————${R}"
echo -e "${D1}                Servis V2ray                 ${R}"
echo -e "${D}—————————————————————————————————————————————${R}"
echo -e ""
echo -e "${B} Servis V2ray telah berjaya dipasang!${R}"
sleep 2
clear
...
systemctl restart v2ray@mkcp.service
...
echo -e "   ———————————————————————————————————————————————————————" 	| tee -a log-install.txt
echo -e "   *                     Servis V2ray                    *" 	| tee -a log-install.txt
echo -e "   ———————————————————————————————————————————————————————" 	| tee -a log-install.txt
echo -e "   ► V2ray Vmess Tls  		  :342"  			| tee -a log-install.txt
echo -e "   ► V2ray Vmess None Tls  	  :982"  			| tee -a log-install.txt
echo -e "   ► V2ray Vless Tls  		  :2083"  			| tee -a log-install.txt
echo -e "   ► V2ray Vless None Tls  	  :8889"  			| tee -a log-install.txt
echo -e "   ———————————————————————————————————————————————————————" 	| tee -a log-install.txt
