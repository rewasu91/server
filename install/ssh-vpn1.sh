...
#menu
wget -O menu "https://raw.githubusercontent.com/rewasu91/server/main/menu/menupakej1/menu1.sh"
...
wget -O port-trojan "https://raw.githubusercontent.com/rewasu91/server/main/editport/port-trojan1.sh"
