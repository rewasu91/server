...
#menu
wget -O menu "https://raw.githubusercontent.com/rewasu91/server/main/menu/menupakej2/menu1.sh"
...
wget -O port-trojan2 "https://raw.githubusercontent.com/rewasu91/server/main/editport/port-trojan2.sh"
