...
wget -O /etc/trojan-go/trojan-go https://raw.githubusercontent.com/rewasu91/server/main/install/trojan-go
wget -O /etc/trojan-go/geoip.dat https://raw.githubusercontent.com/rewasu91/server/main/mix/geoip.dat
wget -O /etc/trojan-go/geosite.dat https://raw.githubusercontent.com/rewasu91/server/main/mix/geosite.dat
